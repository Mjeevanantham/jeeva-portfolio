...
"[project]/components/AlfredBot.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function AlfredBot(param) {
    let { serverUrl = 'http://localhost:3000', position = 'bottom-right', theme = 'dark', showPulse = true, autoOpen = false } = param;
    _s();
    ...
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: '1',
            text: "Hi! I'm Alfred, your AI assistant. I can help you learn about Jeevanantham's work, projects, and experience. What would you like to know?",
            isBot: true,
            timestamp: new Date()
        }
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AlfredBot.useEffect": ()=>{
            ...
            const connectSocket = {
                "AlfredBot.useEffect.connectSocket": ()=>{
                    try {
                        const wsUrl = serverUrl.replace('http', 'ws');
                        const socket = new WebSocket("".concat(wsUrl, "/socket.io/?EIO=4&transport=websocket"));
                        socket.onopen = ({
                            "AlfredBot.useEffect.connectSocket": ()=>{
                                setIsConnected(true);
                                console.log('Connected to Alfred bot');
                            }
                        })["AlfredBot.useEffect.connectSocket"];
                        socket.onclose = ({
                            "AlfredBot.useEffect.connectSocket": ()=>{
                                setIsConnected(false);
                                console.log('Disconnected from Alfred bot');
                                // Attempt to reconnect after 3 seconds
                                setTimeout(connectSocket, 3000);
                            }
                        })["AlfredBot.useEffect.connectSocket"];
                        socket.onerror = ({
                            "AlfredBot.useEffect.connectSocket": (error)=>{
                        ...
                        console.error('Failed to connect to Alfred bot:', error);
                        setIsConnected(false);
                    }
                }
            }["AlfredBot.useEffect.connectSocket"];
    ...
    const sendMessage = async ()=>{
        ...
        try {
            ...
            if (socketRef.current && socketRef.current.readyState === WebSocket.OPEN) {
                ...
                const response = await fetch("".concat(serverUrl, "/api/chat"), {
                    method: 'POST',
                    headers: {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed ".concat(positionClasses[position], " z-50 w-80 h-96 flex flex-col"),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                    className: "h-full flex flex-col ".concat(themeClasses[theme]),
                    children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    fileName: "[project]/components/AlfredBot.tsx",
                                                    lineNumber: 181,
                                                    columnNumber: 21
                                                }, this)
                                            }, void 0, false, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        messages.map((message)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex ".concat(message.isBot ? 'justify-start' : 'justify-end'),
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "max-w-[80%] p-3 rounded-lg ".concat(message.isBot ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white' : 'bg-gradient-to-r from-blue-600 to-purple-600 text-white'),
                                                    children: [
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                ...
                                                placeholder: "Ask me anything about Jeeva's work...",
                                                className: "flex-1",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed ".concat(positionClasses[position], " z-40"),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    onClick: ()=>setIsOpen(!isOpen),
                    className: "w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 ".concat(showPulse && isConnected ? 'animate-pulse' : ''),
                    style: {
...
_s(AlfredBot, "aaaac8lE6m5uK05jp6+i+fBp9bM=");
_c = AlfredBot;
var _c;
__turbopack_context__.k.register(_c, "AlfredBot");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fa1b6d2a._.js.map
...
const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    current: true,
    achievements: [
      "Built 50+ APIs powering CRM modules for 500+ users",
      "Deployed 6 production modules with 100% uptime",
      "Reduced API latency by ~30% via query and index tuning",
      "Led Dockerization and deployment workflows",
    ],
  ...
  },
  {
    ...
    achievements: [
      "Shipped robust REST and GraphQL endpoints",
      "Designed role-based access control (RBAC) system",
      "Built full‑stack features with Next.js + Node.js",
